...
flow divided by destination demand. This is a cleared-flow diagram, not a
counterfactual supply curve or a plot of unused production capacity.
"""
...
def main() -> None:
    ...
    print("Created 24-panel median-price merit order and six enlarged region pages.")
